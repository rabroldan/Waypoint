...
def process_file(file_path,title=None,number = None,output=None): # process the file from txt to HTML
    ...
    if number is None:
        ...
        ## Support for changing the file extension to html for conversion
            ...
            with open(new_file_path, 'w') as html_file: # this will write the contents to the new html file
...
def set_config():
    ...
    elif not sys.argv[config_index+1].endswith(".toml"): # if directory or non-TOML file is provided
